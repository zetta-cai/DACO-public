...
intercache_lbound_latency_list = [3000, 4500, 6000, 7500]
intercache_avg_latency_list = [6000, 9000, 12000, 15000]
intercache_rbound_latency_list = [9000, 13500, 18000, 22500]
...
for tmp_round_index in round_indexes:
    ...
    for tmp_cache_name in cache_names:
        ...
        for i in range(len(intercache_avg_latency_list)):
            ...
            tmp_log_filepath = "{}/tmp_evaluator_for_{}_avg{}.out".format(tmp_log_dirpath, tmp_cache_name, tmp_avg_latency)
