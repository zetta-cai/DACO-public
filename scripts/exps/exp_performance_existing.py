...
# cache_names = ["covered", "shark", "bestguess", "arc", "cachelib", "fifo", "frozenhot", "gdsf", "lfu", "lhd", "lru", "s3fifo", "sieve", "wtinylfu", "lrb", "glcache", "segcache"] # Run 5 rounds for all statistics
cache_names = ["covered", "shark", "bestguess"] # TMPDEBUG: Run 5 more rounds for cross-edge network overhead due to displaying more statistics (single-node caches are zero)
