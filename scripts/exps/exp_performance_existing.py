...
cache_names = ["covered", "shark", "bestguess", "magnet", "arc", "cachelib", "fifo", "frozenhot", "gdsf", "lacache", "lfu", "lhd", "lru", "s3fifo", "sieve", "wtinylfu", "lrb", "glcache", "segcache"] # Run 5 rounds for all statistics
