...
cache_names = ["covered", "shark", "bestguess", "magnet", "arc", "cachelib", "fifo", "frozenhot", "gdsf", "lfu", "lhd", "lru", "s3fifo", "sieve", "wtinylfu", "lrb", "glcache", "segcache"] # Run 5 rounds for all statistics
