...
properties_filepath = "{}/fbphoto.properties".format(Common.trace_dirpath)

# Dump into the binary file
if not os.path.exists(properties_filepath):
    print("Dump dataset file...")
    os.makedirs(os.path.dirname(properties_filepath), exist_ok=True)
    with open(properties_filepath, "wb") as f:
