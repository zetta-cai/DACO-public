...
exclude_dirs += "|src/cache/cachelib|src/cache/greedydual|src/cache/lfu|src/cache/lru|src/cache/segcache|src/cache/lhd|src/cache/fifo|src/cache/sieve|src/cache/s3fifo|src/cache/glcache|src/cache/lrb|src/cache/frozenhot|src/cache/arc" # Baselines (NOTE: src/cache/covered is for COVERED instead of baseline)
...
#exclude_files = "\"(src/Makefile" # Root makefile
#exclude_files += "|src/cache/cachelib_local_cache.*|src/cache/fifo_local_cache.*|src/cache/greedy_dual_local_cache.*|src/cache/lfu_local_cache.*|src/cache/lhd_local_cache.*|src/cache/lru_local_cache.*|src/cache/segcache_local_cache.*|src/cache/sieve_local_cache.*|src/cache/s3fifo_local_cache.*|src/cache/glcache_local_cache.*|src/cache/lrb_local_cache.*|src/cache/frozenhot_local_cache.*|src/cache/arc_local_cache.*)\"" # Redundant code for baseline wrappers
