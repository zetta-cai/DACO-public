...
PathUtil.replace_dir(Common.scriptname, default_facebook_config_filepath, current_facebook_config_filepath, "config.json")
print("")
...
PathUtil.replace_dir(Common.scriptname, default_lib_dirpath, Common.lib_dirpath, "scripts/cachelib/build-package.sh")
print("")
...
PathUtil.replace_dir(Common.scriptname, default_cachebench_dirpath, current_cachebench_dirpath, "src/mk/lib/cachebench.mk")

# Update LFU_DIRPATH for LFU cache
default_lfu_dirpath = "lib/caches"
current_lfu_dirpath = "{}/caches".format(Common.lib_dirpath)
PathUtil.replace_dir(Common.scriptname, default_lfu_dirpath, current_lfu_dirpath, "src/mk/cache/lfu.mk")
...
PathUtil.replace_dir(Common.scriptname, default_boost_dirpath, current_boost_dirpath, "src/mk/lib/boost.mk")
...
PathUtil.replace_dir(Common.scriptname, default_rocksdb_dirpath, current_rocksdb_dirpath, "src/mk/lib/rocksdb.mk")
...
PathUtil.replace_dir(Common.scriptname, default_smhasher_dirpath, current_smhasher_dirpath, "src/mk/lib/smhasher.mk")
...
PathUtil.replace_dir(Common.scriptname, default_tommyds_dirpath, current_tommyds_dirpath, "src/mk/lib/tommyds.mk")

# Update LHD_DIRPATH for lhd
default_lhd_dirpath = "lib/lhd"
current_lhd_dirpath = "{}/lhd".format(Common.lib_dirpath)
PathUtil.replace_dir(Common.scriptname, default_lhd_dirpath, current_lhd_dirpath, "src/mk/cache/lhd.mk")