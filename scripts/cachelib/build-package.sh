...
CMAKE_PREFIX_PATH="/home/sysheng/projects/covered-private/lib/boost_1_81_0/install:$PREFIX/lib/cmake:$PREFIX/lib64/cmake:$PREFIX/lib:$PREFIX/lib64:$PREFIX:${CMAKE_PREFIX_PATH:-}"
