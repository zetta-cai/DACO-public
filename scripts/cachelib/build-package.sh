...
CMAKE_PREFIX_PATH="/home/jzcai/projects/covered-private/lib/boost-1.81.0/install:$PREFIX/lib/cmake:$PREFIX/lib64/cmake:$PREFIX/lib:$PREFIX/lib64:$PREFIX:${CMAKE_PREFIX_PATH:-}"
