...
int main(int argc, char **argv) {
    ...
    if (covered::EvaluatorWrapper::IS_HIGH_PRIORITY_FOR_EVALUATOR)
    {
    ...
    {
        covered::ThreadLauncher::pthreadCreateLowPriority(tmp_thread_name, &evaluator_thread, covered::EvaluatorWrapper::launchEvaluator, (void*)(&evaluator_param));
    }
