...
namespace covered
{
    ...
    const std::string Event::EDGE_CACHE_SERVER_WORKER_TRIGGER_PLACEMENT_EVENT_NAME("edge::cache_server_worker::trigger_placement");
    ...
    const std::string Event::BG_EDGE_CACHE_SERVER_METADATA_UPDATE_PROCESSOR_UPDATE_EVENT_NAME("bg::edge::cache_server_metadata_update_processor::update");
