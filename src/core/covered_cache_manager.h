...
namespace covered
{
    ...
    public:
        ...
        VictimSyncset accessVictimTrackerForLocalVictimSyncset(const uint32_t& dst_edge_idx) const; // Get complete/delta victim syncset from victim tracker for piggybacking-based victim synchronization (dst_edge_idx is used to update prev victim syncset towards dst edge idx)
