...
namespace covered
{
    ...
    KeyValueHitflagMessage::KeyValueHitflagMessage(const Key& key, const Value& value, const Hitflag& hitflag, const MessageType& message_type) : MessageBase(message_type), key_(key), value_(value), hitflag_(hitflag)
    {
    }
