 ...
 *
 * For SwitchSlotRequest, unsigned_integer_ is a target measurement slot index.
 * 
...
namespace covered
{
    ...
    {
    public:
        UintMessage(const uint32_t& unsigned_integer, const MessageType& message_type, const uint32_t& source_index, const NetworkAddr& source_addr, const BandwidthUsage& bandwidth_usage, const EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr);
