/*
 * KeyWriteflagValidityDirectoryVictimsetMessage: the base class for messages each with a key, a write flag, a validity boolean, a directory information, and victim syncset.
 *
...
#ifndef KEY_WRITEFLAG_VALIDITY_DIRECTORY_VICTIMSET_MESSAGE_H
#define KEY_WRITEFLAG_VALIDITY_DIRECTORY_VICTIMSET_MESSAGE_H
