...
namespace covered
{
    ...
    LocalGetResponse::LocalGetResponse(const Key& key, const Value& value, const Hitflag& hitflag, const uint32_t& source_index) : KeyValueHitflagMessage(key, value, hitflag, MessageType::kLocalGetResponse, source_index)
    {
    }
