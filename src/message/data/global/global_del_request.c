...
namespace covered
{
    ...
    GlobalDelRequest::GlobalDelRequest(const Key& key, const uint32_t& source_index, const NetworkAddr& source_addr) : KeyMessage(key, MessageType::kGlobalDelRequest, source_index, source_addr, EventList())
    {
    }
