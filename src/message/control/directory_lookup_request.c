...
namespace covered
{
    ...
    DirectoryLookupRequest::DirectoryLookupRequest(const Key& key, const uint32_t& source_index, const NetworkAddr& source_addr) : KeyMessage(key, MessageType::kDirectoryLookupRequest, source_index, source_addr)
    {
    }
