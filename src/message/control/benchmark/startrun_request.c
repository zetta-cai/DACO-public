...
namespace covered
{
    ...
    StartrunRequest::StartrunRequest(const uint32_t& source_index, const NetworkAddr& source_addr) : SimpleMessage(MessageType::kStartrunRequest, source_index, source_addr, BandwidthUsage(), EventList(), true)
    {
    }
