...
namespace covered
{
    ...
    SimpleFinishrunResponse::SimpleFinishrunResponse(const uint32_t& source_index, const NetworkAddr& source_addr, const EventList& event_list) : SimpleMessage(MessageType::kSimpleFinishrunResponse, source_index, source_addr, event_list)
    {
    }
