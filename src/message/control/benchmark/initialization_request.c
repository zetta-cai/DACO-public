...
namespace covered
{
    ...
    InitializationRequest::InitializationRequest(const uint32_t& source_index, const NetworkAddr& source_addr) : SimpleMessage(MessageType::kInitializationRequest, source_index, source_addr, EventList())
    {
    }
