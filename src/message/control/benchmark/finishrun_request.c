...
namespace covered
{
    ...
    FinishrunRequest::FinishrunRequest(const uint32_t& source_index, const NetworkAddr& source_addr) : SimpleMessage(MessageType::kFinishrunRequest, source_index, source_addr, EventList(), true)
    {
    }
