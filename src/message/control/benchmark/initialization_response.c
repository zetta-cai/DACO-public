...
namespace covered
{
    ...
    InitializationResponse::InitializationResponse(const uint32_t& source_index, const NetworkAddr& source_addr, const EventList& event_list, const uint32_t& msg_seqnum) : SimpleMessage(MessageType::kInitializationResponse, source_index, source_addr, BandwidthUsage(), event_list, ExtraCommonMsghdr(true, false, msg_seqnum)) // NOTE: ONLY msg seqnum in extra common msghdr will be used
    {
    }
