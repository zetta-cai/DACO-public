...
namespace covered
{
    ...
    InitializationResponse::InitializationResponse(const uint32_t& source_index, const NetworkAddr& source_addr, const EventList& event_list) : SimpleMessage(MessageType::kInitializationResponse, source_index, source_addr, BandwidthUsage(), event_list, true)
    {
    }
