...
namespace covered
{
    ...
    FinishWarmupRequest::FinishWarmupRequest(const uint32_t& source_index, const NetworkAddr& source_addr) : SimpleMessage(MessageType::kFinishWarmupRequest, source_index, source_addr, EventList())
    {
    }
