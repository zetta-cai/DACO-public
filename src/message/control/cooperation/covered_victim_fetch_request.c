...
namespace covered
{
    ...
    CoveredVictimFetchRequest::CoveredVictimFetchRequest(const uint32_t& object_size, const uint32_t& source_index, const NetworkAddr& source_addr, const bool& skip_propagation_latency) : UintMessage(object_size, MessageType::kCoveredVictimFetchRequest, source_index, source_addr, BandwidthUsage(), EventList(), skip_propagation_latency)
    {
    }
