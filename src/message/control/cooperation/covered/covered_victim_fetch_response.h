...
namespace covered
{
    ...
    {
    public:
        // CoveredVictimFetchResponse(const VictimSyncset& victim_fetchset, const VictimSyncset& victim_syncset, const uint32_t& source_index, const NetworkAddr& source_addr, const BandwidthUsage& bandwidth_usage, const EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr);
        CoveredVictimFetchResponse(const VictimSyncset& victim_fetchset, const uint32_t& source_index, const NetworkAddr& source_addr, const BandwidthUsage& bandwidth_usage, const EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr);
