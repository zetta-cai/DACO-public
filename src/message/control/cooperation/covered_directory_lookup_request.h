...
namespace covered
{
    class CoveredDirectoryLookupRequest : public KeyPopularityVictimsetMessage
    {
    public:
        CoveredDirectoryLookupRequest(const Key& key, const Popularity& local_uncached_popularity, const VictimSyncset& victim_syncset, const uint32_t& source_index, const NetworkAddr& source_addr, const bool& skip_propagation_latency);
