...
namespace covered
{
    ...
    InvalidationRequest::InvalidationRequest(const Key& key, const uint32_t& source_index, const NetworkAddr& source_addr, const bool& skip_propagation_latency) : KeyMessage(key, MessageType::kInvalidationRequest, source_index, source_addr, EventList(), skip_propagation_latency)
    {
    }
