...
namespace covered
{
    ...
    AcquireWritelockRequest::AcquireWritelockRequest(const Key& key, const uint32_t& source_index, const NetworkAddr& source_addr) : KeyMessage(key, MessageType::kAcquireWritelockRequest, source_index, source_addr)
    {
    }
