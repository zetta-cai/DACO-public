 ...
 *   -> We use global client index as deterministic seed to generate different items (i.e., workloads) for all clients, yet with the same items for all workers of a specific client.
