...
SEGCACHE_INCDIR = -I$(SEGCACHE_DIRPATH)/src -I$(SEGCACHE_DIRPATH)/deps/ccommon/include
...
SEGCACHE_LDLIBS = -l:libseg.a -l:libccommon.so -l:libdatapool.a -l:libhotkey.a -l:libtime.a -l:libutil.a
