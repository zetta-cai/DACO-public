...
# concurrency module
CONCURRENCY_SRCFILES := $(wildcard $(COVERED_DIRPATH)/lock/*.c)
...
COVERED_OBJECTS = $(BENCHMARK_OBJECTS) $(CACHE_OBJECTS) $(CLOUD_OBJECTS) $(COMMON_OBJECTS) $(COOPERATION_OBJECTS) $(EDGE_OBJECTS) $(HASH_OBJECTS) $(CONCURRENCY_OBJECTS) $(MESSAGE_OBJECTS) $(NETWORK_OBJECTS) $(STATISTICS_OBJECTS) $(WORKLOAD_OBJECTS)