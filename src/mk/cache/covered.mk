...
# edge module
EDGE_SRCFILES := $(wildcard $(COVERED_DIRPATH)/edge/*.c) $(wildcard $(COVERED_DIRPATH)/edge/beacon_server/*.c) $(wildcard $(COVERED_DIRPATH)/edge/cache_server/*.c) $(wildcard $(COVERED_DIRPATH)/edge/invalidation_server/*.c) $(wildcard $(COVERED_DIRPATH)/edge/utils/*.c) $(wildcard $(COVERED_DIRPATH)/edge/synchronization_server/*.c)
