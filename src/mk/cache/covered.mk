...
# lock module
LOCK_SRCFILES := $(wildcard $(COVERED_DIRPATH)/lock/*.c)
LOCK_OBJECTS += $(LOCK_SRCFILES:.c=.o)
LOCK_SHARED_OBJECTS += $(LOCK_SRCFILES:.c=.shared.o)
DEPS += $(LOCK_SRCFILES:.c=.d)
CLEANS += $(LOCK_OBJECTS) $(LOCK_SHARED_OBJECTS)
...
COVERED_OBJECTS = $(BENCHMARK_OBJECTS) $(CACHE_OBJECTS) $(CLOUD_OBJECTS) $(COMMON_OBJECTS) $(COOPERATION_OBJECTS) $(EDGE_OBJECTS) $(HASH_OBJECTS) $(LOCK_OBJECTS) $(MESSAGE_OBJECTS) $(NETWORK_OBJECTS) $(STATISTICS_OBJECTS) $(WORKLOAD_OBJECTS)