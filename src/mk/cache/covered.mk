...
# core module
CORE_SRCFILES := $(wildcard $(COVERED_DIRPATH)/core/*.c) $(wildcard $(COVERED_DIRPATH)/core/victim/*.c) $(wildcard $(COVERED_DIRPATH)/core/popularity/*.c)
...
# edge module
EDGE_SRCFILES := $(wildcard $(COVERED_DIRPATH)/edge/*.c) $(wildcard $(COVERED_DIRPATH)/edge/beacon_server/*.c) $(wildcard $(COVERED_DIRPATH)/edge/cache_server/*.c) $(wildcard $(COVERED_DIRPATH)/edge/invalidation_server/*.c) $(wildcard $(COVERED_DIRPATH)/edge/utils/*.c)
...
# NOTE: NOT all programs need $(CLOUD_OBJECTS)
COVERED_OBJECTS = $(BENCHMARK_OBJECTS) $(CACHE_OBJECTS) $(CLI_OBJECTS) $(COMMON_OBJECTS) $(COOPERATION_OBJECTS) $(CORE_OBJECTS) $(EDGE_OBJECTS) $(EVENT_OBJECTS) $(HASH_OBJECTS) $(CONCURRENCY_OBJECTS) $(MESSAGE_OBJECTS) $(NETWORK_OBJECTS) $(STATISTICS_OBJECTS) $(WORKLOAD_OBJECTS)
