...
# message module
MESSAGE_SRCFILES := $(wildcard $(COVERED_DIRPATH)/message/*.c) $(wildcard $(COVERED_DIRPATH)/message/data/global/*.c) $(wildcard $(COVERED_DIRPATH)/message/data/local/*.c) $(wildcard $(COVERED_DIRPATH)/message/data/redirected/*.c) $(wildcard $(COVERED_DIRPATH)/message/control/cooperation/*.c) $(wildcard $(COVERED_DIRPATH)/message/control/benchmark/*.c)
...
COVERED_OBJECTS = $(BENCHMARK_OBJECTS) $(CACHE_OBJECTS) $(CLOUD_OBJECTS) $(COMMON_OBJECTS) $(COOPERATION_OBJECTS) $(EDGE_OBJECTS) $(EVENT_OBJECTS) $(HASH_OBJECTS) $(CONCURRENCY_OBJECTS) $(MESSAGE_OBJECTS) $(NETWORK_OBJECTS) $(STATISTICS_OBJECTS) $(WORKLOAD_OBJECTS)