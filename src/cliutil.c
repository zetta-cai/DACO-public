...
int main(int argc, char **argv) {
    ...
    const std::string SINGLE_NODE_PREFIX_STRING = "SingleNode:";
    ...
    cliutil_cli.clearIsToCliString();
    std::string single_node_cli_string = ((covered::SingleNodeCLI*)&cliutil_cli)->toCliString();
    cliutil_cli.clearIsToCliString();
    ...
    oss << SINGLE_NODE_PREFIX_STRING << single_node_cli_string << std::endl;
