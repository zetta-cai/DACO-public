...
namespace covered
{
    ...
    void WorkloadCLI::addCliParameters_()
    {
        if (!is_add_cli_parameters_)
        {
            ...
            std::string workload_name_descstr = "workload name (e.g., " + Util::FACEBOOK_WORKLOAD_NAME + ", " + Util::ZIPF_FACEBOOK_WORKLOAD_NAME + ", " + Util::ZIPF_WIKIPEDIA_IMAGE_WORKLOAD_NAME + ", " + Util::ZIPF_WIKIPEDIA_TEXT_WORKLOAD_NAME + ", " + Util::ZIPF_TENCENT_PHOTO1_WORKLOAD_NAME + ", and " + Util::ZIPF_TENCENT_PHOTO2_WORKLOAD_NAME + ")";
