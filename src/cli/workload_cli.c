...
namespace covered
{
    ...
    void WorkloadCLI::checkWorkloadName_() const
    {
        ...
        if (workload_name_ != Util::FACEBOOK_WORKLOAD_NAME && workload_name_ != Util::ZIPF_FACEBOOK_WORKLOAD_NAME && workload_name_ != Util::ZIPF_WIKIPEDIA_IMAGE_WORKLOAD_NAME && workload_name_ != Util::ZIPF_WIKIPEDIA_TEXT_WORKLOAD_NAME && workload_name_ != Util::ZIPF_TENCENT_PHOTO1_WORKLOAD_NAME && workload_name_ != Util::ZIPF_TENCENT_PHOTO2_WORKLOAD_NAME && workload_name_ != Util::ZIPF_FBPHOTO_WORKLOAD_NAME && workload_name_ != Util::ZIPF_TWITTERKV2_WORKLOAD_NAME && workload_name_ != Util::ZIPF_TWITTERKV4_WORKLOAD_NAME)
        {
            std::ostringstream oss;
