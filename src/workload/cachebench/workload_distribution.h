/*
 * WorkloadGenerator: refer to lib/CacheLib/cachelib/cachebench/workload/WorkloadDistribution.h.
 *
...
#include "workload/cachebench/fast_discrete.h"
...
class WorkloadDistribution {
 public:
  explicit WorkloadDistribution(const DistributionConfig& c)
    ...
    if (opDist_.probabilities().size() != static_cast<uint8_t>(facebook::cachelib::cachebench::OpType::kSize)) {
      throw std::invalid_argument(
