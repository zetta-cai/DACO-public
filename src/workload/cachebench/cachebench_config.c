...
StressorConfig::StressorConfig(const folly::dynamic& configJson) {
  ...
  // below
  facebook::cachelib::cachebench::checkCorrectSize<StressorConfig, 496>();
}
...
CacheBenchConfig::CacheBenchConfig(
  ...
  stressorConfig_ = stressorConfigCustomizer
                        ...
                        : stressorConfig;
  auto cacheConfig = facebook::cachelib::cachebench::CacheConfig{configJson["cache_config"]};
  cacheConfig_ =
...
DistributionConfig::DistributionConfig(const folly::dynamic& jsonConfig,
  ...
  facebook::cachelib::cachebench::checkCorrectSize<DistributionConfig, 368>();
}
...
ReplayGeneratorConfig::ReplayGeneratorConfig(const folly::dynamic& configJson) {
  ...
  facebook::cachelib::cachebench::checkCorrectSize<ReplayGeneratorConfig, 128>();
}
...
MLAdmissionConfig::MLAdmissionConfig(const folly::dynamic& configJson) {
  ...
  facebook::cachelib::cachebench::checkCorrectSize<MLAdmissionConfig, 160>();
}
