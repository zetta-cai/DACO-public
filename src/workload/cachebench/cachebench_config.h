/*
 * CacheBenchConfig: refer to lib/CacheLib/cachelib/cachebench/util/Config.*.
 *
 * Hack to disable unnecessary outputs for multi-client benchmark.
 * 
...
struct DistributionConfig : public facebook::cachelib::cachebench::JSONConfig {
...
struct MLAdmissionConfig : public facebook::cachelib::cachebench::JSONConfig {
  MLAdmissionConfig() {}
...
struct ReplayGeneratorConfig : public facebook::cachelib::cachebench::JSONConfig {
...
struct StressorConfig : public facebook::cachelib::cachebench::JSONConfig {
...
// json
using CacheConfigCustomizer = std::function<facebook::cachelib::cachebench::CacheConfig(facebook::cachelib::cachebench::CacheConfig)>;
...
class CacheBenchConfig {
 public:
  ...
  const facebook::cachelib::cachebench::CacheConfig& getCacheConfig() const { return cacheConfig_; }
  const StressorConfig& getStressorConfig() const { return stressorConfig_; }

 private:
  facebook::cachelib::cachebench::CacheConfig cacheConfig_;
