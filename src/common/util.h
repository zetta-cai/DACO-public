...
namespace covered
{
    ...
    public:
        ...
        static const std::string ZIPF_WIKIPEDIA_IMAGE_WORKLOAD_NAME; // Workload generator type (power-law Zipf-based Wikipedia image workload; using Zeta distribution)
        static const std::string ZIPF_WIKIPEDIA_TEXT_WORKLOAD_NAME; // Workload generator type (power-law Zipf-based Wikipedia text workload; using Zeta distribution)
        static const std::string ZIPF_TENCENT_PHOTO1_WORKLOAD_NAME; // Workload generator type (power-law Zipf-based Tencent photo1 workload; using Zeta distribution)
        static const std::string ZIPF_TENCENT_PHOTO2_WORKLOAD_NAME; // Workload generator type (power-law Zipf-based Tencent photo2 workload; using Zeta distribution)
        static const std::string ZETA_WIKIPEDIA_IMAGE_WORKLOAD_NAME; // (NOT use scripts/workload/characterize_zeta_traces.py by default) Workload generator type (zeta-based Zipf-based Wikipedia image workload; using Zeta distribution)
        static const std::string ZETA_WIKIPEDIA_TEXT_WORKLOAD_NAME; // (NOT use scripts/workload/characterize_zeta_traces.py by default) Workload generator type (zeta-based Zipf-based Wikipedia text workload; using Zeta distribution)
        static const std::string ZETA_TENCENT_PHOTO1_WORKLOAD_NAME; // (NOT use scripts/workload/characterize_zeta_traces.py by default) Workload generator type (zeta-based Zipf-based Tencent photo1 workload; using Zeta distribution)
        static const std::string ZETA_TENCENT_PHOTO2_WORKLOAD_NAME; // (NOT use scripts/workload/characterize_zeta_traces.py by default) Workload generator type (zeta-based Zipf-based Tencent photo2 workload; using Zeta distribution)
        ...
        static std::string getSampledDatasetFilepath(const std::string& workload_name);
        static std::string getSampledWorkloadFilepath(const std::string& workload_name);
