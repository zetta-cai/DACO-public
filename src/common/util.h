...
namespace covered
{
    ...
    public:
        ...
        // Workload name
        static const std::string AKAMAI_WEB_WORKLOAD_NAME; // (OBSOLETE due to originally designed for single-node trace generation) TRAGEN-generated Akamai's web CDN trace (geo-distributed)
        static const std::string AKAMAI_VIDEO_WORKLOAD_NAME; // (OBSOLETE due to originally designed for single-node trace generation) TRAGEN-generated Akamai's video CDN trace (geo-distributed)
        ...
        static const std::string ZIPF_WIKIPEDIA_IMAGE_WORKLOAD_NAME; // Workload generator type (power-law Zipf-based Wikipedia image workload)
        ...
        static const std::string ZETA_WIKIPEDIA_TEXT_WORKLOAD_NAME; // (NOT use scripts/workload/characterize_zeta_traces.py by default) Workload generator type (zeta-based Zipf-based Wikipedia text workload)
        static const std::string ZETA_TENCENT_PHOTO1_WORKLOAD_NAME; // (NOT use scripts/workload/characterize_zeta_traces.py by default) Workload generator type (zeta-based Zipf-based Tencent photo1 workload)
        static const std::string ZETA_TENCENT_PHOTO2_WORKLOAD_NAME; // (NOT use scripts/workload/characterize_zeta_traces.py by default) Workload generator type (zeta-based Zipf-based Tencent photo2 workload)
