...
namespace covered
{
    ...
    public:
        ...
        static uint16_t getEdgeCacheServerRedirectionProcessorRecvrspPort(const uint32_t& edge_idx, const uint32_t& edgecnt);
        static uint16_t getEdgeCacheServerVictimFetchProcessorRecvrspPort(const uint32_t& edge_idx, const uint32_t& edgecnt);
