...
namespace covered
{
    ...
    const std::string Util::ZIPF_WIKIPEDIA_IMAGE_WORKLOAD_NAME("zipf_wikiimage"); // Zipfian Wikipedia image workload generator (based on Zeta distribution)
    const std::string Util::ZIPF_WIKIPEDIA_TEXT_WORKLOAD_NAME("zipf_wikitext"); // Zipfian Wikipedia text workload generator (based on Zeta distribution)
    ...
    std::string Util::getInfixForEvaluatorStatisticsFilepath_(EvaluatorCLI* evaluator_cli_ptr)
    {
        ...
        // Example: covered_capacitymb1000_clientcnt1_warmupspeedup1_edgecnt1_hashnamemmh3_keycnt1000000_perclientopcnt1000000_percacheserverworkercnt1_perclientworkercnt1_propagationus100010000100000_warmupscale5_warmupmaxdurationsec0_stresstestdurationsec10_facebook
