...
namespace covered
{
    ...
    const std::string Util::LACACHE_CACHE_NAME("lacache");
    ...
    const std::string Util::SHARK_EXTENDED_LACACHE_CACHE_NAME("shark+lacache");
    ...
    const std::string Util::MAGNET_EXTENDED_LACACHE_CACHE_NAME("magnet+lacache");
