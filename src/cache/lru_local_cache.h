...
namespace covered
{
    ...
    private:
        ...
        virtual bool getLocalUncachedPopularityFromLocalCacheInternal_(const Key& key, Popularity& local_uncached_popularity, const ObjectSize& object_size) const override; // Return true if local uncached key is tracked
