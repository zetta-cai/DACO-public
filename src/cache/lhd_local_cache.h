/*
 * LhdLocalCache: local edge cache with LHD policy (https://github.com/CMU-CORGI/LHD).
 * 
 * By Siyuan Sheng (2023.12.08).
 */

#ifndef LHD_LOCAL_CACHE_H
#define LHD_LOCAL_CACHE_H

#include "cache/lhd/lhd.hpp"
...
namespace covered
{
    ...
    private:
        ...
        repl::LHD* lhd_cache_ptr_; // Data and metadata for local edge cache
    };
}
