...
namespace covered
{
    ...
    std::list<VictimCacheinfo> SieveLocalCache::getLocalSyncedVictimCacheinfosFromLocalCacheInternal_() const
    {
    ...
    void SieveLocalCache::getCollectedPopularityFromLocalCacheInternal_(const Key& key, CollectedPopularity& collected_popularity) const
    {
    ...
    void SieveLocalCache::updateLocalCacheMetadataInternal_(const Key& key, const std::string& func_name, const void* func_param_ptr)
    {
