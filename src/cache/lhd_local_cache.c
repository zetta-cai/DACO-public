...
namespace covered
{
    ...
    std::list<VictimCacheinfo> LhdLocalCache::getLocalSyncedVictimCacheinfosFromLocalCacheInternal_() const
    {
    ...
    void LhdLocalCache::getCollectedPopularityFromLocalCacheInternal_(const Key& key, CollectedPopularity& collected_popularity) const
    {
    ...
    void LhdLocalCache::updateLocalCacheMetadataInternal_(const Key& key, const std::string& func_name, const void* func_param_ptr)
    {
