...
#ifndef FIFO_LOCAL_CACHE_H
#define FIFO_LOCAL_CACHE_H

#include <string>

#include "cache/fifo/fifo_cache_policy.hpp"
#include "cache/local_cache_base.h"

namespace covered
{
    class FifoLocalCache : public LocalCacheBase
    {
    public:
        FifoLocalCache(const EdgeWrapperBase* edge_wrapper_ptr, const uint32_t& edge_idx, const uint64_t& capacity_bytes);
        virtual ~FifoLocalCache();
    ...
    private:
        ...
        FIFOCachePolicy<Key, Value, KeyHasher>* fifo_cache_ptr_; // Data and metadata for local edge cache
    };
}
