...
#include <config.h> // Siyuan: lib/glcache/micro-implementation/build/include/config.h (NOTE: use brackets instead of quotes to avoid covered's common module mis-include common/config.h)
#include <libCacheSim/cacheObj.h> // Siyuan: lib/glcache/micro-implementation/build/include/libCacheSim/cacheObj.h
#include <libCacheSim/request.h> // Siyuan: lib/glcache/micro-implementation/build/include/libCacheSim/request.h

#include "cache/glcache/mymath.h" // Siyuan: src/cache/glcache/mymath.h
#include "cache/glcache/hashtableStruct.h" // Siyuan: src/cache/glcache/hashtableStruct.h

#if HASHTABLE_TYPE == CHAINED_HASHTABLE
#include "cache/glcache/chainedHashTable.h"
...
#include "cache/glcache/chainedHashTableV2.h"
