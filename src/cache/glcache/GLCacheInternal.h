...
#include "cache/glcache/GLCache.h" // Siyuan: src/cache/glcache/GLCache.h
#include "cache/glcache/glcache_policy.h" // Siyuan: src/cache/glcache/glcache_policy.h

// Siyuan: use C-style raw function names
#ifdef __cplusplus
extern "C" {
#endif
...
/********************** init ********************/
void cpp_init_global_params();
void deinit_global_params();
void cpp_check_params(GLCache_params_t *init_params);
void cpp_init_seg_sel(cache_t *cache);
