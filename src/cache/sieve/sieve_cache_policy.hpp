/*
 * SieveCachePolicy: as code is not open sourced when building COVERED project, we refer to Algorithm 1 in the original paper of SIEVE for reimplementation.
 * 
