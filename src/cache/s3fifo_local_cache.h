...
#ifndef S3FIFO_LOCAL_CACHE_H
#define S3FIFO_LOCAL_CACHE_H

#include <string>

#include "cache/s3fifo/s3fifo_cache_policy.hpp"
...
namespace covered
{
    ...
    private:
        ...
        S3fifoCachePolicy<Key, Value, KeyHasher>* s3fifo_cache_ptr_; // Data and metadata for local edge cache
    };
}
