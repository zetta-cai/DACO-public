...
// Siyuan: src/cache/segcache/deps/ccommon/include/cc_config.h (NOTE: cc_config.h is generated by CMake; use cc_config.h instead of config.h to avoid conflicting name with libCacheSim's config.h in GLCache project)
#include <cc_config.h>
