...
namespace covered
{
    ...
    public:
        ...
        void updateForDegrouped(const Key& key, const Value& original_value); // Update group-level metadata for the key being removed from the current group (currently evicted/detracked for local cached/uncached)
