/*
 * GroupLevelStatistics: group-level statistics for each object in local edge cache.
 * 
 * By Siyuan Sheng (2023.08.16).
 */

#ifndef GROUP_LEVEL_STATISTICS_H
#define GROUP_LEVEL_STATISTICS_H
...
namespace covered
{
    class GroupLevelStatistics
    {
    public:
        GroupLevelStatistics();
        ~GroupLevelStatistics();
