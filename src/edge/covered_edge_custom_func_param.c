...
namespace covered
{
    ...
    TryToTriggerCachePlacementForGetrspFuncParam::TryToTriggerCachePlacementForGetrspFuncParam(const Key& key, const Value& value, const CollectedPopularity& collected_popularity_after_fetch_value, const FastPathHint& fast_path_hint, const bool& is_global_cached, BandwidthUsage& total_bandwidth_usage, EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), value_const_ref_(value), collected_popularity_const_ref_(collected_popularity_after_fetch_value), fast_path_hint_const_ref_(fast_path_hint), is_global_cached_(is_global_cached), bandwidth_usage_ref_(total_bandwidth_usage), event_list_ref_(event_list), extra_common_msghdr_(extra_common_msghdr)
    {
        is_finish_ = false;
    }
    ...
    ExtraCommonMsghdr TryToTriggerCachePlacementForGetrspFuncParam::getExtraCommonMsghdr() const
    {
    ...
    TryToTriggerPlacementNotificationAfterHybridFetchFuncParam::TryToTriggerPlacementNotificationAfterHybridFetchFuncParam(const Key& key, const Value& value, const Edgeset& best_placement_edgeset, BandwidthUsage& total_bandwidth_usage, EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), value_const_ref_(value), best_placement_edgeset_const_ref_(best_placement_edgeset), bandwidth_usage_ref_(total_bandwidth_usage), event_list_ref_(event_list), extra_common_msghdr_(extra_common_msghdr)
    {
        is_finish_ = false;
    }
    ...
    ExtraCommonMsghdr TryToTriggerPlacementNotificationAfterHybridFetchFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    NotifyBeaconForPlacementAfterHybridFetchFuncParam::NotifyBeaconForPlacementAfterHybridFetchFuncParam(const Key& key, const Value& value, const Edgeset& best_placement_edgeset, const NetworkAddr& recvrsp_source_addr, UdpMsgSocketServer* recvrsp_socket_server_ptr, BandwidthUsage& total_bandwidth_usage, EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr) : TryToTriggerPlacementNotificationAfterHybridFetchFuncParam(key, value, best_placement_edgeset, total_bandwidth_usage, event_list, extra_common_msghdr), recvrsp_source_addr_(recvrsp_source_addr), recvrsp_socket_server_ptr_(recvrsp_socket_server_ptr)
    {
    }
    ...
    NonblockDataFetchForPlacementFuncParam::NonblockDataFetchForPlacementFuncParam(const Key& key, const Edgeset& best_placement_edgeset, const ExtraCommonMsghdr& extra_common_msghdr, const bool& sender_is_beacon, bool& need_hybrid_fetching) : EdgeCustomFuncParamBase(), key_const_ref_(key), best_placement_edgeset_const_ref_(best_placement_edgeset), extra_common_msghdr_(extra_common_msghdr), sender_is_beacon_(sender_is_beacon), need_hybrid_fetching_ref_(need_hybrid_fetching)
    {
    }
    ...
    ExtraCommonMsghdr NonblockDataFetchForPlacementFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    NonblockDataFetchFromCloudForPlacementFuncParam::NonblockDataFetchFromCloudForPlacementFuncParam(const Key& key, const Edgeset& best_placement_edgeset, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), best_placement_edgeset_const_ref_(best_placement_edgeset), extra_common_msghdr_(extra_common_msghdr)
    {
    }
    ...
    ExtraCommonMsghdr NonblockDataFetchFromCloudForPlacementFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    NonblockNotifyForPlacementFuncParam::NonblockNotifyForPlacementFuncParam(const Key& key, const Value& value, const Edgeset& best_placement_edgeset, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), value_const_ref_(value), best_placement_edgeset_const_ref_(best_placement_edgeset), extra_common_msghdr_(extra_common_msghdr)
    {
    }
    ...
    ExtraCommonMsghdr NonblockNotifyForPlacementFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    ProcessMetadataUpdateRequirementFuncParam::ProcessMetadataUpdateRequirementFuncParam(const Key& key, const MetadataUpdateRequirement& metadata_update_requirement, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), metadata_update_requirement_const_ref_(metadata_update_requirement), extra_common_msghdr_(extra_common_msghdr)
    {
    }
    ...
    ExtraCommonMsghdr ProcessMetadataUpdateRequirementFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    AfterDirectoryLookupHelperFuncParam::AfterDirectoryLookupHelperFuncParam(const Key& key, const uint32_t& source_edge_idx, const CollectedPopularity& collected_popularity, const bool& is_global_cached, const bool& is_source_cached, Edgeset& best_placement_edgeset, bool& need_hybrid_fetching, FastPathHint* fast_path_hint_ptr, UdpMsgSocketServer* recvrsp_socket_server_ptr, const NetworkAddr& recvrsp_source_addr, BandwidthUsage& total_bandwidth_usage, EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), source_edge_idx_(source_edge_idx), collected_popularity_const_ref_(collected_popularity), is_global_cached_(is_global_cached), is_source_cached_(is_source_cached), best_placement_edgeset_ref_(best_placement_edgeset), need_hybrid_fetching_ref_(need_hybrid_fetching), fast_path_hint_ptr_(fast_path_hint_ptr), recvrsp_socket_server_ptr_(recvrsp_socket_server_ptr), recvrsp_source_addr_(recvrsp_source_addr), total_bandwidth_usage_ref_(total_bandwidth_usage), event_list_ref_(event_list), extra_common_msghdr_(extra_common_msghdr)
    {
        is_finish_ = false;
    }
    ...
    ExtraCommonMsghdr AfterDirectoryLookupHelperFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    ExtraCommonMsghdr AfterDirectoryAdmissionHelperFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    AfterDirectoryEvictionHelperFuncParam::AfterDirectoryEvictionHelperFuncParam(const Key& key, const uint32_t& source_edge_idx, const MetadataUpdateRequirement& metadata_update_requirement, const DirectoryInfo& directory_info, const CollectedPopularity& collected_popularity, const bool& is_global_cached, Edgeset& best_placement_edgeset, bool& need_hybrid_fetching, UdpMsgSocketServer* recvrsp_socket_server_ptr, const NetworkAddr& recvrsp_source_addr, BandwidthUsage& total_bandwidth_usage, EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr, const bool& is_background) : EdgeCustomFuncParamBase(), key_const_ref_(key), source_edge_idx_(source_edge_idx), metadata_update_requirement_const_ref_(metadata_update_requirement), directory_info_const_ref_(directory_info), collected_popularity_const_ref_(collected_popularity), is_global_cached_(is_global_cached), best_placement_edgeset_ref_(best_placement_edgeset), need_hybrid_fetching_ref_(need_hybrid_fetching), recvrsp_socket_server_ptr_(recvrsp_socket_server_ptr), recvrsp_source_addr_(recvrsp_source_addr), total_bandwidth_usage_ref_(total_bandwidth_usage), event_list_ref_(event_list), extra_common_msghdr_(extra_common_msghdr), is_background_(is_background)
    {
        is_finish_ = false;
    }
    ...
    ExtraCommonMsghdr AfterDirectoryEvictionHelperFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    AfterWritelockAcquireHelperFuncParam::AfterWritelockAcquireHelperFuncParam(const Key& key, const uint32_t& source_edge_idx, const CollectedPopularity& collected_popularity, const bool& is_global_cached, const bool& is_source_cached, UdpMsgSocketServer* recvrsp_socket_server_ptr, const NetworkAddr& recvrsp_source_addr, BandwidthUsage& total_bandwidth_usage, EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), source_edge_idx_(source_edge_idx), collected_popularity_const_ref_(collected_popularity), is_global_cached_(is_global_cached), is_source_cached_(is_source_cached), recvrsp_socket_server_ptr_(recvrsp_socket_server_ptr), recvrsp_source_addr_(recvrsp_source_addr), total_bandwidth_usage_ref_(total_bandwidth_usage), event_list_ref_(event_list), extra_common_msghdr_(extra_common_msghdr)
    {
        is_finish_ = false;
    }
    ...
    ExtraCommonMsghdr AfterWritelockAcquireHelperFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
    ...
    AfterWritelockReleaseHelperFuncParam::AfterWritelockReleaseHelperFuncParam(const Key& key, const uint32_t& source_edge_idx, const CollectedPopularity& collected_popularity, const bool& is_source_cached, Edgeset& best_placement_edgeset, bool& need_hybrid_fetching, UdpMsgSocketServer* recvrsp_socket_server_ptr, const NetworkAddr& recvrsp_source_addr, BandwidthUsage& total_bandwidth_usage, EventList& event_list, const ExtraCommonMsghdr& extra_common_msghdr) : EdgeCustomFuncParamBase(), key_const_ref_(key), source_edge_idx_(source_edge_idx), collected_popularity_const_ref_(collected_popularity), is_source_cached_(is_source_cached), best_placement_edgeset_ref_(best_placement_edgeset), need_hybrid_fetching_ref_(need_hybrid_fetching), recvrsp_socket_server_ptr_(recvrsp_socket_server_ptr), recvrsp_source_addr_(recvrsp_source_addr), total_bandwidth_usage_ref_(total_bandwidth_usage), event_list_ref_(event_list), extra_common_msghdr_(extra_common_msghdr)
    {
        is_finish_ = false;
    }
    ...
    ExtraCommonMsghdr AfterWritelockReleaseHelperFuncParam::getExtraCommonMsghdr() const
    {
        return extra_common_msghdr_;
    }
