...
namespace covered
{
    ...
    bool BeaconServerBase::processDirectoryLookupRequest_(MessageBase* control_request_ptr, const NetworkAddr& edge_cache_server_worker_recvrsp_dst_addr) const
    {
        ...
        total_bandwidth_usage.update(BandwidthUsage(0, cross_edge_directory_lookup_req_bandwidth_bytes, 0, 0, 1, 0, control_request_ptr->getMessageType(), control_request_ptr->getVictimSyncsetBytes()));
    ...
    bool BeaconServerBase::processDirectoryUpdateRequest_(MessageBase* control_request_ptr, const NetworkAddr& edge_cache_server_worker_recvrsp_dst_addr)
    {
        ...
        total_bandwidth_usage.update(BandwidthUsage(0, cross_edge_directory_update_req_bandwidth_bytes, 0, 0, 1, 0, control_request_ptr->getMessageType(), control_request_ptr->getVictimSyncsetBytes()));
    ...
    bool BeaconServerBase::processAcquireWritelockRequest_(MessageBase* control_request_ptr, const NetworkAddr& edge_cache_server_worker_recvrsp_dst_addr)
    {
        ...
        total_bandwidth_usage.update(BandwidthUsage(0, cross_edge_acquire_writelock_req_bandwidth_bytes, 0, 0, 1, 0, control_request_ptr->getMessageType(), control_request_ptr->getVictimSyncsetBytes()));
    ...
    bool BeaconServerBase::processReleaseWritelockRequest_(MessageBase* control_request_ptr, const NetworkAddr& edge_cache_server_worker_recvrsp_dst_addr)
    {
        ...
        total_bandwidth_usage.update(BandwidthUsage(0, cross_edge_release_writelock_req_bandwidth_bytes, 0, 0, 1, 0, control_request_ptr->getMessageType(), control_request_ptr->getVictimSyncsetBytes()));
