...
namespace covered
{
    ...
    protected:
        ...
        virtual void processRspToLookupBeaconDirectory_(MessageBase* control_response_ptr, bool& is_being_written, bool& is_valid_directory_exist, DirectoryInfo& directory_info, Edgeset& best_placement_edgeset, bool& need_hybrid_fetching, FastPathHint& fast_path_hint) const = 0;
        ...
        virtual bool updateLocalEdgeCache_(const Key& key, const Value& value, const bool& is_global_cached) const = 0; // Return if key is cached after udpate
        virtual bool removeLocalEdgeCache_(const Key& key, const bool& is_global_cached) const = 0; // Return if key is cached after removal
