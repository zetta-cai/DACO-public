...
namespace covered
{
    ...
    bool BasicCacheServerPlacementProcessor::processPlacementNotifyRequest_(MessageBase* data_request_ptr, const NetworkAddr& recvrsp_dst_addr)
    {
        ...
        total_bandwidth_usage.update(BandwidthUsage(0, bestguess_placement_notify_request_ptr->getMsgBandwidthSize(), 0, 0, 1, 0, bestguess_placement_notify_request_ptr->getMessageType(), bestguess_placement_notify_request_ptr->getVictimSyncsetBytes()));
