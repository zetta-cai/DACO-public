...
namespace covered
{
    ...
    bool CacheServerRedirectionProcessorBase::processRedirectedGetRequest_(MessageBase* redirected_request_ptr, const NetworkAddr& recvrsp_dst_addr) const
    {
        ...
        total_bandwidth_usage.update(BandwidthUsage(0, cross_edge_redirected_get_req_bandwidth_bytes, 0, 0, 1, 0, redirected_request_ptr->getMessageType(), redirected_request_ptr->getVictimSyncsetBytes()));
